...
<div class="page">
	...
	<form id="user_form" enctype="multipart/form-data" method="post">
		...
		<div class="ncap-form-default">
			...
			<dl class="row">
				<dt class="tit">
					<label for="member_mobile"><em>*</em><?php echo $lang['member_index_iphone']?></label>
				</dt>
				<dd class="opt">
					<input type="text" value="" name="member_mobile" id="member_mobile" class="input-txt">
					<span class="err"></span>
					<p class="notic">用于登录</p>
				</dd>
			</dl>
			<dl class="row">
				<dt class="tit">
...
$(function(){
	...
	$('#user_form').validate({
		...
		messages : {
			...
			member_mobile : {
				required : '<i class="fa fa-exclamation-circle"></i><?php echo '手机号不能为空'; ?>',
				digits: '<i class="fa fa-exclamation-circle"></i><?php echo 'asdad'?>',
				mobile: '<i class="fa fa-exclamation-circle"></i><?php echo 'gghfghdf'?>',
				remote : '<i class="fa fa-exclamation-circle"></i><?php echo '手机号有重复，换一个吧'?>'
			}
		}
	});
});
