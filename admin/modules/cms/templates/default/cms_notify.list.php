...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			<div class="subject">
				<h3><?php echo $lang['nc_cms_notify_manage'];?></h3>
	...
	<div class="explanation" id="explanation">
		...
		<ul>
			<li><?php echo $lang['cms_notify_list_tip1'];?></li>
...
function update_flex(){
		$("#flexigrid").flexigrid({
				url: 'index.php?act=cms_notify&op=cms_notify_xml',
				colModel : [
...
function fg_operation(name, bDiv) {
		if (name == 'add') {
				window.location.href = 'index.php?act=cms_notify&op=cms_notify_add';
		}
}
