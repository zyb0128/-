...
class BaseSellerControl extends Control {
	...
	private function _getMenuList() {
		$menu_list = array(
			...
			'message' => array('name' => '客户管理', 'child' => array(
				array('name' => '会员设置', 'act' => 'store_vip', 'op' => 'index'),
			)),
			'store' => array('name' => '结算管理', 'child' => array(
				array('name' => '实物结算', 'act'=>'store_bill', 'op'=>'index'),
				array('name' => '水币记录', 'act'=>'store_water', 'op' => 'index'),
			)),
			'promotion' => array('name' => '政策管理', 'child' => array(
				...
				array('name' => '添加返利政策', 'act'=>'store_privilege', 'op'=>'index'),
				array('name' => '返利结算', 'act'=>'store_brokerage', 'op'=>'index'),
				array('name' => '水币充值', 'act'=>'', 'op'=>'index'),
			)),
			...
			'statistics' => array('name' => '运营统计', 'child' => array(
